...
MERGE INTO users (id, username, password, full_name, email, is_active) 
KEY (id) VALUES (1, 'demo', 'password', 'Demo User', 'demo@bankingapp.com', true);
...
MERGE INTO accounts (id, user_id, account_type, account_name, balance, created_at) 
KEY (id) VALUES (1, 1, 'CHECKING', 'Primary Checking', 1500.00, CURRENT_TIMESTAMP);

-- Account 2: Savings account with $3,250.75 balance  
MERGE INTO accounts (id, user_id, account_type, account_name, balance, created_at) 
KEY (id) VALUES (2, 1, 'SAVINGS', 'Emergency Savings', 3250.75, CURRENT_TIMESTAMP);

-- Account 3: Additional checking account with $875.50 balance
MERGE INTO accounts (id, user_id, account_type, account_name, balance, created_at) 
KEY (id) VALUES (3, 1, 'CHECKING', 'Secondary Checking', 875.50, CURRENT_TIMESTAMP);
...
MERGE INTO transactions (id, from_account_id, to_account_id, amount, description, transaction_date)
KEY (id) VALUES (1, 1, 2, 200.00, 'Emergency fund contribution', '2025-11-18 14:30:00');

-- Transaction 2: Deposit to primary checking
MERGE INTO transactions (id, from_account_id, to_account_id, amount, description, transaction_date)
KEY (id) VALUES (2, NULL, 1, 1000.00, 'Salary deposit - Direct Deposit', '2025-11-17 09:00:00');

-- Transaction 3: Transfer between checking accounts  
MERGE INTO transactions (id, from_account_id, to_account_id, amount, description, transaction_date)
KEY (id) VALUES (3, 1, 3, 150.00, 'Monthly budget allocation', '2025-11-15 16:45:00');

-- Transaction 4: Withdrawal from secondary checking
MERGE INTO transactions (id, from_account_id, to_account_id, amount, description, transaction_date)
KEY (id) VALUES (4, 3, NULL, 75.00, 'ATM withdrawal', '2025-11-13 18:20:00');

-- Transaction 5: Large savings deposit
MERGE INTO transactions (id, from_account_id, to_account_id, amount, description, transaction_date)
KEY (id) VALUES (5, NULL, 2, 500.00, 'Tax refund deposit', '2025-11-06 11:15:00');

-- Transaction 6: Transfer from savings to checking
MERGE INTO transactions (id, from_account_id, to_account_id, amount, description, transaction_date)
KEY (id) VALUES (6, 2, 1, 300.00, 'Monthly expense funding', '2025-10-30 08:30:00');
